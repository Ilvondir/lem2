...
discretizer = Discretizer()
discretizer.fit(train_data, ['length'], number_of_output_values=5)
discretizer.fit(train_data, ['words_number'], number_of_output_values=5)
discretizer.fit(train_data, ['mean_word_length'], number_of_output_values=5)
discretizer.fit(train_data, ['punctuation_percentage'], number_of_output_values=5, verbose=1)
